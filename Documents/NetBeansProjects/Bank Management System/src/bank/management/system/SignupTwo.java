...
import java.awt.*;
import java.util.*;
import com.toedter.calendar.JDateChooser; //to include calendar in field
...
public class SignupTwo extends JFrame implements ActionListener {
    ...
    SignupTwo(){
        ...
        setLayout(null);        // to place text in appropriate position on frame
    ...
    public void actionPerformed(ActionEvent ae){    //enter value into dbs action
        ...
        String address= addressTextField.getText();     //to pull string directly text fields
